 ...
 * **modo quiosque** (screen pinning) do tablet.
 *
 * ## Modo Quiosque
 *
 * A cada `onResume` o app tenta entrar em [startLockTask] — o que efetivamente
 * trava o tablet neste app via *screen pinning*: na primeira chamada o sistema
 * mostra um diálogo de confirmação. Após o usuário aceitar, o app fica
 * pinned; pode ser destravado segurando Back+Recents juntos.
 *
...
class MainActivity : ComponentActivity() {
    ...
    /**
     * Tenta iniciar o lock task (screen pinning). Não-fatal: se o device não
     * suportar ou o usuário recusar o diálogo, o app continua funcionando sem
     * trava real.
     */
